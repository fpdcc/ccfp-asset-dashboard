  ...
  makeExportData() {
    ...
    this.state.portfolio.projects.forEach(project => {
      ...
      Object.entries(project.assets).forEach(([assetType, assets]) => {
        assetsByType[`gis_${assetType}_assets`] = assets.join(';')
      })
      ...
      let row = {
        ...
        'project_manager': project.project_manager,
        'project_requester': project.project_requester,
        'project_notes': project.notes.replace(/\r\n/g, ' ').replace(/\n/g, ' ').replace(/\r/g, ' '),
        'project_score': project.score,
        'phase_type': project.phase,
        'phase_status': project.phase_status,
        'phase_estimated_bid_quarter': project.estimated_bid_quarter,
        'phase_year': project.phase_year,
        'phase_funding_year': project.funding_year,
        'phase_funding_amount': parseFloat(project.funding_amount) || 0,
        'phase_funding_actual_cost': project.actual_cost,
        'phase_funding_source': project.funding_source,
        'phase_funding_secured': project.funding_secured,
        'phase_funding_total_funded_amount': project.funded_amount,
        'phase_funding_total_estimated_cost': project.budget,
        'countywide': project.countywide,
