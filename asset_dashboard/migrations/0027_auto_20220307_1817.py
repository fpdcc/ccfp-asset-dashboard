# Generated by Django 3.1.7 on 2022-03-07 18:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('asset_dashboard', '0026_auto_20220216_1720'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=11)),
                ('obligated_year', models.IntegerField(blank=True, null=True)),
                ('obligated_completion_date', models.IntegerField(blank=True, null=True)),
                ('funding_secured', models.BooleanField(default=False)),
                ('source_type', models.TextField(choices=[('capital_improvement_fund', 'Capital Improvement Fund'), ('bonds', 'General Obligation Bonds'), ('construction_development', 'Construction & Development'), ('grants_fees_other', 'Grants, Fees, & Other'), ('rollover', 'Rollover')], default='capital_improvement_fund')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='phase',
            name='total_estimated_cost_currency',
        ...
        migrations.DeleteModel(
            name='PhaseFundingYear',
        ),
        migrations.AddField(
            model_name='phase',
            name='funding_streams',
            field=models.ManyToManyField(to='asset_dashboard.FundingStream'),
        ),
    ]
